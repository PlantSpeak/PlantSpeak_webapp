...
from models.Plant_Type import *
from database import db
from wtforms import Form, BooleanField, StringField, PasswordField, validators
import flask_bcrypt

plant_type_pages = Blueprint('plant types', __name__, template_folder="views")
...
@plant_type_pages.route('/register/planttype', methods=['GET','POST'])
def register():
